...
(function(a, b) {
    ...
    function a(a) {
        ...
        g.destroyed && (g.destroyed = !1,
        a.options.container && m(a.options.container, function(a) {
            r(a, "scroll", g.validateT)
        }),
        r(window, "resize", g.saveViewportOffsetT),
        r(window, "resize", g.validateT),
        r(window, "scroll", g.validateT));
        b(a)
    }
    function b(a) {
        for (var g = a._util, c = 0; c < g.count; c++) {
            ...
            if (e || u(b, a.options.successClass))
                a.load(b),
                g.elements.splice(c, 1),
                g.count--,
                c--
        }
        0 === g.count && a.destroy()
    ...
    function e(a, b, c) {
        if (!u(a, c.successClass) && (b || c.loadInvisible || 0 < a.offsetWidth && 0 < a.offsetHeight))
            if (b = a.getAttribute(w) || a.getAttribute(c.src)) {
                ...
                "video" === a.nodeName.toLowerCase() ? (m(a.getElementsByTagName("source"), function(a) {
                    var b = c.src
                      , g = a.getAttribute(b);
                    g && (a.setAttribute("src", g),
                    a.removeAttribute(b))
                }),
                a.load(),
                f(a, c)) : (c.error && c.error(a, "missing"),
                v(a, c.errorClass))
    }
    function f(a, b) {
        v(a, b.successClass);
    ...
    function p(a) {
        k.bottom = (window.innerHeight || document.documentElement.clientHeight) + a;
        k.right = (window.innerWidth || document.documentElement.clientWidth) + a
    }
    function r(a, b, c) {
    ...
    return function(d) {
        ...
        k = {};
        k.top = 0 - c.options.offset;
        k.left = 0 - c.options.offset;
        ...
        c.load = function(a, b) {
            var c = this.options;
            void 0 === a.length ? e(a, b, c) : m(a, function(a) {
                e(a, b, c)
            })
        }
        ;
        c.destroy = function() {
            var a = this._util;
            this.options.container && m(this.options.container, function(b) {
        ...
        ;
        g.validateT = t(function() {
            b(c)
        }, c.options.validateDelay, c);
        g.saveViewportOffsetT = t(function() {
            p(c.options.offset)
        }, c.options.saveViewportOffsetDelay, c);
        p(c.options.offset);
        m(c.options.breakpoints, function(a) {
...
var WPacTime = WPacTime || {
    ...
    getTimeAgo: function(a, b) {
        ...
        return 45 > a ? WPacTime.Messages[b].second : 90 > a ? WPacTime.Messages[b].minute : 45 > d ? WPacTime.Messages[b].minutes(d) : 90 > d ? WPacTime.Messages[b].hour : 24 > e ? WPacTime.Messages[b].hours(e) : 48 > e ? WPacTime.Messages[b].day : 30 > f ? WPacTime.Messages[b].days(f) : 60 > f ? WPacTime.Messages[b].month : 365 > f ? WPacTime.Messages[b].months(f) : 2 > h ? WPacTime.Messages[b].year : WPacTime.Messages[b].years(h)
    },
...
WPacTime.Messages = {
    ru: {
        ...
        month: "\u043c\u0435\u0441\u044f\u0446 \u043d\u0430\u0437\u0430\u0434",
        months: function(a) {
            return WPacTime.declineNum(Math.floor(a / 30), "\u043c\u0435\u0441\u044f\u0446 \u043d\u0430\u0437\u0430\u0434", "\u043c\u0435\u0441\u044f\u0446\u0430 \u043d\u0430\u0437\u0430\u0434", "\u043c\u0435\u0441\u044f\u0446\u0435\u0432 \u043d\u0430\u0437\u0430\u0434")
        },
        year: "\u0433\u043e\u0434 \u043d\u0430\u0437\u0430\u0434",
        years: function(a) {
    ...
    uk: {
        ...
        month: "\u043c\u0456\u0441\u044f\u0446\u044c \u0442\u043e\u043c\u0443",
        months: function(a) {
            return WPacTime.declineNum(Math.floor(a / 30), "\u043c\u0456\u0441\u044f\u0446\u044c \u0442\u043e\u043c\u0443", "\u043c\u0456\u0441\u044f\u0446\u0456 \u0442\u043e\u043c\u0443", "\u043c\u0456\u0441\u044f\u0446\u0456\u0432 \u0442\u043e\u043c\u0443")
        },
        year: "\u0440\u0456\u043a \u0442\u043e\u043c\u0443",
        years: function(a) {
    ...
    kk: {
        ...
        minutes: function(a) {
            return WPacTime.declineNum(Math.round(a), "\u043c\u0438\u043d\u0443\u0442 \u0431\u04b1\u0440\u044b\u043d", "\u043c\u0438\u043d\u0443\u0442 \u0431\u04b1\u0440\u044b\u043d", "\u043c\u0438\u043d\u0443\u0442 \u0431\u04b1\u0440\u044b\u043d")
        },
    ...
    be: {
        ...
        month: "\u043c\u0435\u0441\u044f\u0446 \u0442\u0430\u043c\u0443",
        months: function(a) {
            return WPacTime.declineNum(Math.floor(a / 30), "\u043c\u0435\u0441\u044f\u0446 \u0442\u0430\u043c\u0443", "\u043c\u0435\u0441\u044f\u0446\u0430 \u0442\u0430\u043c\u0443", "\u043c\u0435\u0441\u044f\u0446\u0430\u045e \u0442\u0430\u043c\u0443")
        },
        year: "\u0433\u043e\u0434 \u0442\u0430\u043c\u0443",
        years: function(a) {
...
function rplg_next_reviews(a, b) {
    ...
    for (var f = 0; f < b && f < reviews.length; f++)
        reviews[f] && (reviews[f].className = reviews[f].className.replace("wp-" + a + "-hide", " "),
        rplg_load_imgs(reviews[f]));
    reviews = d.querySelectorAll(e);
...
function _rplg_timeago(a) {
    for (var b = 0; b < a.length; b++) {
        var d = a[b].className;
        -1 < d.indexOf("google") ? (d = parseInt(a[b].getAttribute("data-time")),
        d *= 1E3) : d = -1 < d.indexOf("facebook") ? (new Date(a[b].getAttribute("data-time").replace(/\+\d+$/, ""))).getTime() : (new Date(a[b].getAttribute("data-time").replace(/ /, "T"))).getTime();
...
function _grw_init_slider(a) {
    function b() {
        ...
        b.className = 510 > b.offsetWidth ? "grw-row grw-row-xs" : 750 > b.offsetWidth ? "grw-row grw-row-x" : 1100 > b.offsetWidth ? "grw-row grw-row-s" : 1450 > b.offsetWidth ? "grw-row grw-row-m" : 1800 > b.offsetWidth ? "grw-row grw-row-l" : "grw-row grw-row-xl";
        p.length && setTimeout(d, 200)
    }
    function d() {
        var b = a.querySelector(".grw-slider-reviews")
          ...
          , g = a.querySelector(".grw-slider-dots");
        if (g) {
            g.innerHTML = "";
            for (var m = 0; m < h; m++) {
                var c = document.createElement("div");
                c.className = "grw-slider-dot";
                x = Math.ceil((b.scrollLeft + (b.scrollLeft + d[0].offsetWidth * f)) / 2 * h / b.scrollWidth);
                x == m + 1 && (c.className = "grw-slider-dot active");
                c.setAttribute("data-index", m + 1);
                c.setAttribute("data-visible", f);
                g.appendChild(c);
                c.onclick = function() {
                    ...
                    var c = parseInt(this.getAttribute("data-index"))
                      , d = parseInt(this.getAttribute("data-visible"));
                    b < c ? e(d * Math.abs(c - b)) : n.scrollBy(-p[0].offsetWidth * d * Math.abs(c - b), 0);
    ...
    function e(a) {
        n.scrollBy(p[0].offsetWidth * a, 0)
    }
    function f() {
        var b = a.querySelector(".grw-slider-review:last-child")
          , d = b.getBoundingClientRect();
        b = b.parentNode.getBoundingClientRect();
        (2 > Math.abs(b.left - d.left) || b.left <= d.left) && d.left < b.right && (2 > Math.abs(b.right - d.right) || b.right >= d.right) && d.right > b.left ? n.scrollBy(-n.scrollWidth, 0) : e(1);
        l = setTimeout(f, v)
    }
    var h = a.querySelector(".grw-slider")
      , u = JSON.parse(h.getAttribute("data-options"))
      , v = 1E3 * u.speed
      , n = a.querySelector(".grw-slider-reviews")
      , p = a.querySelectorAll(".grw-slider-review")
      , r = null
      , l = null
      , m = function() {
        (h.offsetWidth || h.offsetHeight || h.getClientRects().length) && "hidden" !== window.getComputedStyle(h).visibility ? (setTimeout(b, 1),
        _rplg_init_blazy(10),
        p.length && u.autoplay && setTimeout(f, v)) : setTimeout(m, 300)
    };
    m();
    ...
    n && n.addEventListener("scroll", function() {
        setTimeout(d, 200);
        window.rplg_blazy && window.rplg_blazy.revalidate()
    });
    var t = a.querySelector(".grw-slider-prev");
    t && (t.onclick = function() {
        n.scrollBy(-p[0].offsetWidth, 0);
        l && clearInterval(l)
    }
    );
    if (t = a.querySelector(".grw-slider-next"))
        t.onclick = function() {
            e(1);
            l && clearInterval(l)
        }
...
function grw_init(a, b) {
    ...
    _rplg_read_more();
    _rplg_init_blazy(10);
    (a = _rplg_get_parent(a, "wp-gr")) && "true" != a.getAttribute("data-exec") && "slider" == b && (a.setAttribute("data-exec", "true"),
    _grw_init_slider(a))
}
